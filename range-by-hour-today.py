...
#   range-by-hour-today.py        Users points by hour for the range
#-----------------------------------------------------------
import pandas as pd
import os
import easygui
...
print "                  ","{:<5}".format(db1[14:18]),
print "{:<5}".format(db2[14:18]),
print "{:<5}".format(db3[14:18]),
print "{:<5}".format(db4[14:18]),
print "{:<5}".format(db5[14:18]),
print "{:<5}".format(db6[14:18]),
print "{:<5}".format(db7[14:18]),
print "{:<5}".format(db8[14:18]),
print "{:<5}".format(db9[14:18]),
print "{:<5}".format(db10[14:18]),
print "{:<5}".format(db11[14:18]),
print "{:<5}".format(db12[14:18]),
print "{:<5}".format(db14[14:18]),
print "{:<5}".format(db15[14:18]),
print "{:<5}".format(db16[14:18]),
print "{:<5}".format(db17[14:18]),
print "{:<5}".format(db18[14:18]),
print "{:<5}".format(db19[14:18]),
print "{:<5}".format(db20[14:18]),
print "{:<5}".format(db21[14:18]),
print "{:<5}".format(db22[14:18]),
print "{:<5}".format(db23[14:18]),
print "{:<5}".format(db24[14:18]),
print "{:<5}".format(db25[14:18])
...
for x in slist:
	...
	print "{0:>5}".format(p8),
	print "{0:>5}".format(p9),
	print "{0:>5}".format(p10),
	print "{0:>5}".format(p11),
	print "{0:>5}".format(p12),
	print "{0:>5}".format(p13),
	print "{0:>5}".format(p14),
	print "{0:>5}".format(p15),
	print "{0:>5}".format(p16),
	print "{0:>5}".format(p17),
	print "{0:>5}".format(p18),
	print "{0:>5}".format(p19),
	print "{0:>5}".format(p20),
	print "{0:>5}".format(p21),
	print "{0:>5}".format(p22),
	print "{0:>5}".format(p23),
	print "{0:>5}".format(p24)
