...
#print name," ",'\t',
	...
	print "{0:>6}".format(p8),
	print "{0:>6}".format(p9),
	print "{0:>6}".format(p10),
	print "{0:>6}".format(p11),
	print "{0:>6}".format(p12),
	print "{0:>6}".format(p13),
	print "{0:>6}".format(p14),
	print "{0:>6}".format(p15),
	print "{0:>6}".format(p16),
	print "{0:>6}".format(p17),
	print "{0:>6}".format(p18),
	print "{0:>6}".format(p19),
	print "{0:>6}".format(p20),
	print "{0:>6}".format(p21),
	print "{0:>6}".format(p22),
	print "{0:>6}".format(p23),
	print "{0:>6}".format(p24)  
